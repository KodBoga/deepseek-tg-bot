// bot.js — Telegram бот для сети клиник «МедГарант»
// Использует DeepSeek V3 для общения с клиентами

const { Telegraf } = require("telegraf");
const fetch = require("node-fetch");

// Токены храним в переменных окружения Railway
...
О клиниках:
Сеть стоматологических клиник называется «МедГарант».
Адреса и ближайшие станции метро указаны на официальных сайтах:
- medgarant-spb.ru
- implantgarant.ru
...
5. если есть интеграция — создай запись через API, если нет — просто дай контакты.`
          ...
          // few-shot пример для закрепления стиля
          {
            role: "user",
