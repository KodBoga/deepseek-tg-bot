...
Твоя задача:
— задать максимум 2 коротких, человеческих уточняющих вопроса,
— затем пригласить на первичный приём и рассказать про акцию.

Примеры стиля уточнений:
...
После 2 уточнений обязательно напиши примерно так (можно перефразировать, но смысл сохранить):
...
Уточнений: ${state.clarifyCount}
    ...
    // Если уточнений >= 2 — жёстко переводим на приём + акция
